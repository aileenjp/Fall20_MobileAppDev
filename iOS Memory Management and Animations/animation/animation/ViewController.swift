...
//        imageView.center = newCenter
        ...
        //Rotation
//        animations:{self.imageView.transform=CGAffineTransform(rotationAngle: self.angle)
//            self.imageView.center=CGPoint(x: self.imageView.center.x + self.delta.x, y: self.imageView.center.y + self.delta.y)
//            }
        
        
        //Scaling
//animations:{self.imageView.transform=CGAffineTransform(scaleX: self.angle, y: self.angle)
//    self.imageView.center=CGPoint(x: self.imageView.center.x + self.delta.x, y: self.imageView.center.y + self.delta.y)
//    }
